...
<body>
	<%
        ...
        if(session.getAttribute("userID")!=null){
			...
			shoppingList.getShoppingList(userID);
        }
		request.setCharacterEncoding("UTF-8");
		int cartID = 0;
	...
	<div class="container" style ="margin-top: 50px">
	    ...
	    <div class="col-lg-12 order-lg-2 mb-4">
	      ...
	      <%
			int totalPrice = 0;
			try{
				if(shoppingList.getShoppingList(userID) == null) {
					out.println("Empty");
				}else{
					for(int i = 0 ; i < shoppingList.cartList.size(); i++){
					ShoppingCart cart = shoppingList.cartList.get(i);
					System.out.println(cart.getBookID());
					Books shoppingBook = shoppingList.getBookList(cart.getBookID()).get(0);
