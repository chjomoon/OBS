	...
	<div class = "container" style ="margin-top: 100px" >
        <div class="col-lg-10 col-md-10 mb-10">
              <div class="card h-100">
                  <img class="card-img-top" src="img/9780385545358_p0_v1_s192x300.jpg" alt="">
                  <div class="card-body" >
                      <h1>
                         <% out.println(result[1]); %>
                      </h1>
                      <h7>Price : $<% out.println(result[9]); %></h7>
                      <br>
                      <!--  p class="card-text" style ="text-algin : left;"</p-->
                      <h7>
                      	 Category :  <% out.println(result[3]); %>
                      </h7>
                         <br>
                       <h7>   
                         Author : <% out.println(result[4]);%>
                       </h7>
                         <br>
                       <h7>
                         Publisher : <% out.println(result[5]); %>
                ...
                session.setAttribute("title",result[1]);
                session.setAttribute("isbn",result[2]);
                session.setAttribute("category",result[3]);
                session.setAttribute("author",result[4]);
                session.setAttribute("publisher",result[5]);
                session.setAttribute("publishedYear",result[6]);
                session.setAttribute("edition",result[7]);
                session.setAttribute("quantity",result[8]);
                session.setAttribute("price",result[9]);
                %>
